...
#include "global.h"
#include "pcg.h"       // magic_pointers, ASSOC_CONST_MP , VECT_xxx and MASK_xxx
...
#define reset_failed_skipped_blocks() clear_failed( -1 );
